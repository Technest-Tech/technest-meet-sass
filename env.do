...
# Public URL for clients (use domain with HTTPS)
NEXT_PUBLIC_LIVEKIT_URL=wss://academy.the-doable.com/rtc
...
# Base URL used in generated links (use domain with HTTPS)
APP_URL=https://academy.the-doable.com
